<template>
    <div class="" style="top: 20%;position: relative;">
        <main>
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-6 align-self-center">
                <h1>403</h1>
                <h2>啊哈! 你没有权限访问此页面哦</h2>
                <p>你可以找管理员寻求帮助或者点击下面按钮返回主页。
                </p>
                <Button shape="circle" to="/info">返回首页</Button>
              </div>
            </div>
          </div>
        </main>
...
<style src="../assets/error/style.css" scoped></style>
