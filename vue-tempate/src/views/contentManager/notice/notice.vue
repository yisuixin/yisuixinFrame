    ...
    export default {
        ...
        methods: {
            ...
            getNoticeList:function () {
                ...
                that.HTTPJS.get(that.HTTPURL.NOTICE.GET_ADMIN_NOTICE_LIST,that.notice.search,successCallback,failCallback,otherCallback);
            },
            //点击搜索
            searchSubmit(){
                const that = this;
            ...
            delNotice:function (id) {
                ...
                that.HTTPJS.post(that.HTTPURL.NOTICE.DEL_NOTICE,{id:id},successCallback);
            },
            //置顶或者取消置顶
            toppingNotice(key,type){
                ...
                that.HTTPJS.post(that.HTTPURL.NOTICE.TOPPING_NOTICE,{id:id,type:type},successCallback);
            },
