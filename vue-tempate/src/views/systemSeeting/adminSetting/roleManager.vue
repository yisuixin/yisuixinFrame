    ...
    export default {
        ...
        methods: {
            ...
            getRoleList:function(){
                ...
                that.HTTPJS.get(that.HTTPURL.RBAC.ROLE.GET_ROLE_LIST,that.roleData.search,successCallback,failCallback);
            },
            //点击添加角色
            ...
            getRoleInfo(id){
                ...
                that.HTTPJS.get(that.HTTPURL.RBAC.ROLE.GET_ROLE_INFO,{id:id},successCallback,failCallback);
            },
            //增加或者编辑角色
            addMode:function(name){
                ...
                this.$refs[name].validate((valid,errors) => {
                    if (valid) {
                        ...
                        that.HTTPJS.post(that.HTTPURL.RBAC.ROLE.ADD_ROLE,that.modeAdd.formInline,successCallback,failCallback);
                    }
                })
            },
            //删除角色
            deleteMenu:function(id,index){
                ...
                that.HTTPJS.post(that.HTTPURL.RBAC.ROLE.DELETE_ROLE,{id:id},successCallback,failCallback);
            },
            //点击搜索 type == 1搜索，2重置
