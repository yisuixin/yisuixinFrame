    ...
    export default {
        ...
        methods: {
            ...
            getRoleList:function(){
                ...
                that.HTTPJS.get(that.HTTPURL.ROLE.GET_ROLE_LIST,that.modeAdd.role.search,successCallback,failCallback);
            },
            //分页
            ...
            getUserList:function(){
                ...
                that.HTTPJS.get(that.HTTPURL.MANAGER.GET_USER_LIST,that.managerData.search,successCallback,failCallback);
            },
            //点击添加管理员
            ...
            addMode:function(name){
                ...
                this.$refs[name].validate((valid,errors) => {
                    if (valid) {
                        ...
                        that.HTTPJS.post(that.HTTPURL.MANAGER.ADD_MANAGER,that.modeAdd.formInline,successCallback,failCallback);
                    }
                })
            },
            //修改状态
            setStatus:function (id,index,type,value) {//type == 1重置密码，2修改状态，3删除
                ...
                that.HTTPJS.post(that.HTTPURL.MANAGER.EDIT_MANAGER,{editManagerId:id,editManagerType:type,editManagerValue:value},successCallback,failCallback);
            },
            //重置密码
            setDefaultPass (id,index,type){
                ...
                that.HTTPJS.post(that.HTTPURL.MANAGER.EDIT_MANAGER,{editManagerId:id,editManagerType:type,editManagerValue:''},successCallback,failCallback);
            },
            //删除管理员
