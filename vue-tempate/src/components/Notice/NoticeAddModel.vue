    ...
    methods: {
      ...
      showModel:function(type){//type == 1显示，2关闭
        ...
        getRoleList(){
            ...
            that.HTTPJS.get(that.HTTPURL.SYSTEM_SRRTING.ROLE.GET_ROLE_LIST,that.roleList.search,successCallback,failCallback);
        },
        //获取角色列表页码改变
        ...
        getUserList(){
            ...
            that.HTTPJS.get(that.HTTPURL.SYSTEM_SRRTING.MANAGER.GET_USER_LIST,that.userList.search,successCallback,failCallback);
        },
        //点击发布公告
        submitNotice(){
          const that = this;
